...
export default function FAQPage() {
  ...
  return (
    <>
      ...
      <PageHero eyebrow="Questions and answers" title="Ark of Bones FAQ" description="Straight answers about current services, products, channels, and contact options." image={ASSETS.hero} compact />
