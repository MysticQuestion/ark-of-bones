...
const pilotSteps = [
  ...
  ['02', 'Scope', 'Choose the game format, production approach, sponsor inventory, content rights, and measurement.'],
  ...
  return (
    <>
      ...
      <section className="partnership-proof" aria-label="Partnership system">
        ...
        <article><Camera aria-hidden="true" /><span>Recorded media</span><p>A plan that defines what is filmed and how it is delivered.</p></article>
