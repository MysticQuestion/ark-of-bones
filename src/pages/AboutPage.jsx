...
const work = [
  ...
  ['Brands', 'Distinct culture and competition identities under one parent company.', Radio],
  ['Merchandise', 'Official products that carry Ark of Bones and its subsidiaries beyond the table.', Package],
...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="leadership-band"><div><p className="eyebrow">Leadership</p><h2>Official company representation</h2></div><p>Leadership, press, and company inquiries are handled directly through the Ark of Bones contact team.</p></section>
